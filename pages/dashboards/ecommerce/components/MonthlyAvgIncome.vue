  ...
  <b-col md="12" lg="8">
    <b-card no-body>
      ...
      <b-card-body class="pt-0">
        <ApexChart :chart="monthlyIncomeChart" class="apex-charts" id="monthly_income" />
        <b-row>
          <b-col md="6" lg="3" v-for="(item, idx) in monthlyIncomeData" :key="idx">
...
import { monthlyIncomeChart, monthlyIncomeData } from '~/pages/dashboards/ecommerce/components/data'
import MonthlyIncomeCard from '~/pages/dashboards/ecommerce/components/MonthlyIncomeCard.vue'
</script>
