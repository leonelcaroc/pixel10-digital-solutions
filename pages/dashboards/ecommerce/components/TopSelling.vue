        ...
        <b-row class="align-items-center">
          ...
          <div class="col-auto">
            <b-dropdown variant="light" menu-class="dropdown-menu-end">
              <template #button-content> <i class="icofont-calendar fs-5 me-1"></i> This Month<i class="las la-angle-down ms-1"></i> </template>
          ...
          <b-tbody>
            <b-tr v-for="(item, idx) in topSelling" :key="idx">
              <b-td class="px-0">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 text-truncate">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="progress bg-primary-subtle w-100" style="height: 5px" role="progressbar" aria-label="Success example" :aria-valuenow="item.progress" aria-valuemin="0" aria-valuemax="100">
              ...
              <b-td class="px-0 text-end"
                ><span class="text-body ps-2 align-self-center text-end">{{ currency }}{{ item.sales }}</span>
              </b-td>
            </b-tr>
          </b-tbody>
        </b-table-simple>
