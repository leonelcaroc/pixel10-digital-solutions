              ...
              <table class="main" width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid rgba(130, 134, 156, 0.15)" bgcolor="transparent">
                <tr>
                  <td class="alert alert-primary border-0 bg-primary" style="padding: 20px; border-radius: 0" align="center" valign="top">
                    <img :src="bell" alt="" style="margin-left: auto; margin-right: auto; display: block; width: 60px" />
                  </td>
                </tr>
                <tr>
                  <td class="alert alert-dark border-0" style="color: #ffffff; background-color: #212f56; padding: 20px; border-radius: 0" align="center" valign="top">Warning: You're approaching your limit. Please upgrade.</td>
                </tr>
                <tr>
                  <td class="content-wrap" style="padding: 20px" valign="top">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td class="content-block" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; text-align: center" valign="top">Thanks for choosing <b>Rizz</b> Admin.</td>
                      </tr>
                    </table>
                  </td>
                </tr>
